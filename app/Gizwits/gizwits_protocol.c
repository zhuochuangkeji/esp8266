...
static int8_t ICACHE_FLASH_ATTR gizDataPoint2Event(gizwitsIssued_t *issuedData, eventInfo_t *info, dataPoint_t *dataPoints)
{
    ...
    if(0x01 == issuedData->attrFlags.flagRelay)
    {
        ...
        info->num++;
        dataPoints->valueRelay = gizDecompressionValue(RELAY_BYTEOFFSET,RELAY_BITOFFSET,RELAY_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }



    if(0x01 == issuedData->attrFlags.flagRelay1)
    {
        info->event[info->num] = EVENT_RELAY1;
        info->num++;
        dataPoints->valueRelay1 = gizDecompressionValue(RELAY1_BYTEOFFSET,RELAY1_BITOFFSET,RELAY1_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }



    if(0x01 == issuedData->attrFlags.flagRelay2)
    {
        info->event[info->num] = EVENT_RELAY2;
        info->num++;
        dataPoints->valueRelay2 = gizDecompressionValue(RELAY2_BYTEOFFSET,RELAY2_BITOFFSET,RELAY2_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }



    if(0x01 == issuedData->attrFlags.flagRelay3)
    {
        info->event[info->num] = EVENT_RELAY3;
        info->num++;
        dataPoints->valueRelay3 = gizDecompressionValue(RELAY3_BYTEOFFSET,RELAY3_BITOFFSET,RELAY3_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }



    if(0x01 == issuedData->attrFlags.flagEnumeration)
    {
        info->event[info->num] = EVENT_ENUMERATION;
        info->num++;
        dataPoints->valueEnumeration = gizDecompressionValue(ENUMERATION_BYTEOFFSET,ENUMERATION_BITOFFSET,ENUMERATION_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }



    if(0x01 == issuedData->attrFlags.flagData0)
    {
        info->event[info->num] = EVENT_DATA0;
        info->num++;
        dataPoints->valueData0 = gizX2Y(DATA0_RATIO,  DATA0_ADDITION, issuedData->attrVals.valueData0); 
    }



    if(0x01 == issuedData->attrFlags.flagData1)
    {
        info->event[info->num] = EVENT_DATA1;
        info->num++;
        dataPoints->valueData1 = gizX2Y(DATA1_RATIO,  DATA1_ADDITION, issuedData->attrVals.valueData1); 
    }



    if(0x01 == issuedData->attrFlags.flagData2)
    {
        info->event[info->num] = EVENT_DATA2;
        info->num++;
        dataPoints->valueData2 = gizX2Y(DATA2_RATIO,  DATA2_ADDITION, issuedData->attrVals.valueData2); 
    }



    if(0x01 == issuedData->attrFlags.flagData3)
    {
        info->event[info->num] = EVENT_DATA3;
        info->num++;
        dataPoints->valueData3 = gizX2Y(DATA3_RATIO,  DATA3_ADDITION, issuedData->attrVals.valueData3); 
    }



    if(0x01 == issuedData->attrFlags.flagData4)
    {
        info->event[info->num] = EVENT_DATA4;
        info->num++;
        dataPoints->valueData4 = gizX2Y(DATA4_RATIO,  DATA4_ADDITION, issuedData->attrVals.valueData4); 
    }



    if(0x01 == issuedData->attrFlags.flagData5)
    {
        info->event[info->num] = EVENT_DATA5;
        info->num++;
        dataPoints->valueData5 = gizX2Y(DATA5_RATIO,  DATA5_ADDITION, issuedData->attrVals.valueData5); 
    }



    if(0x01 == issuedData->attrFlags.flagData6)
    {
        info->event[info->num] = EVENT_DATA6;
        info->num++;
        dataPoints->valueData6 = gizX2Y(DATA6_RATIO,  DATA6_ADDITION, issuedData->attrVals.valueData6); 
    }



    if(0x01 == issuedData->attrFlags.flagData7)
    {
        info->event[info->num] = EVENT_DATA7;
        info->num++;
        dataPoints->valueData7 = gizX2Y(DATA7_RATIO,  DATA7_ADDITION, issuedData->attrVals.valueData7); 
    }



    if(0x01 == issuedData->attrFlags.flagData8)
    {
        info->event[info->num] = EVENT_DATA8;
        info->num++;
        dataPoints->valueData8 = gizX2Y(DATA8_RATIO,  DATA8_ADDITION, issuedData->attrVals.valueData8); 
    }



    if(0x01 == issuedData->attrFlags.flagData9)
    {
        info->event[info->num] = EVENT_DATA9;
        info->num++;
        dataPoints->valueData9 = gizX2Y(DATA9_RATIO,  DATA9_ADDITION, issuedData->attrVals.valueData9); 
    }



    if(0x01 == issuedData->attrFlags.flagData10)
    {
        info->event[info->num] = EVENT_DATA10;
        info->num++;
        dataPoints->valueData10 = gizX2Y(DATA10_RATIO,  DATA10_ADDITION, issuedData->attrVals.valueData10); 
    }
    ...
    if(0x01 == issuedData->attrFlags.flagBig_data)
    {
        info->event[info->num] = EVENT_BIG_DATA;
        info->num++;
        memcpy((uint8_t *)dataPoints->valueBig_data,issuedData->attrVals.valueBig_data,sizeof(issuedData->attrVals.valueBig_data));
    }
...
static int8_t ICACHE_FLASH_ATTR gizCheckReport(dataPoint_t *cur, dataPoint_t *last)
{
    ...
    if(last->valueRelay1 != cur->valueRelay1)
    {
        GIZWITS_LOG("valueRelay1 Changed\n");
        ret = 1;
    }
    if(last->valueRelay2 != cur->valueRelay2)
    {
        GIZWITS_LOG("valueRelay2 Changed\n");
        ret = 1;
    }
    if(last->valueRelay3 != cur->valueRelay3)
    {
        GIZWITS_LOG("valueRelay3 Changed\n");
        ret = 1;
    }
    if(last->valueEnumeration != cur->valueEnumeration)
    {
        GIZWITS_LOG("valueEnumeration Changed\n");
        ret = 1;
    }
    if(last->valueData0 != cur->valueData0)
    {
        GIZWITS_LOG("valueData0 Changed\n");
        ret = 1;
    }
    if(last->valueData1 != cur->valueData1)
    {
        GIZWITS_LOG("valueData1 Changed\n");
        ret = 1;
    }
    if(last->valueData2 != cur->valueData2)
    {
        GIZWITS_LOG("valueData2 Changed\n");
        ret = 1;
    }
    if(last->valueData3 != cur->valueData3)
    {
        GIZWITS_LOG("valueData3 Changed\n");
        ret = 1;
    }
    if(last->valueData4 != cur->valueData4)
    {
        GIZWITS_LOG("valueData4 Changed\n");
        ret = 1;
    }
    if(last->valueData5 != cur->valueData5)
    {
        GIZWITS_LOG("valueData5 Changed\n");
        ret = 1;
    }
    if(last->valueData6 != cur->valueData6)
    {
        GIZWITS_LOG("valueData6 Changed\n");
        ret = 1;
    }
    if(last->valueData7 != cur->valueData7)
    {
        GIZWITS_LOG("valueData7 Changed\n");
        ret = 1;
    }
    if(last->valueData8 != cur->valueData8)
    {
        GIZWITS_LOG("valueData8 Changed\n");
        ret = 1;
    }
    if(last->valueData9 != cur->valueData9)
    {
        GIZWITS_LOG("valueData9 Changed\n");
        ret = 1;
    }
    if(last->valueData10 != cur->valueData10)
    {
        GIZWITS_LOG("valueData10 Changed\n");
        ret = 1;
    }
    if(0 != memcmp((uint8_t *)&last->valueBig_data,(uint8_t *)&cur->valueBig_data,sizeof(last->valueBig_data)))
    {
        GIZWITS_LOG("valueBig_data Changed\n");
        ret = 1;
    }

    if(last->valueADC != cur->valueADC)
    {
        if(gizGetTimerCount()-lastReportTime >= REPORT_TIME_MAX)
        {
            GIZWITS_LOG("valueADC Changed\n");
...
static int8_t ICACHE_FLASH_ATTR gizDataPoints2ReportData(dataPoint_t *dataPoints , devStatus_t *devStatusPtr)
{
    ...
    gizCompressValue(RELAY_BYTEOFFSET,RELAY_BITOFFSET,RELAY_LEN,(uint8_t *)devStatusPtr,dataPoints->valueRelay);
    gizCompressValue(RELAY1_BYTEOFFSET,RELAY1_BITOFFSET,RELAY1_LEN,(uint8_t *)devStatusPtr,dataPoints->valueRelay1);
    gizCompressValue(RELAY2_BYTEOFFSET,RELAY2_BITOFFSET,RELAY2_LEN,(uint8_t *)devStatusPtr,dataPoints->valueRelay2);
    gizCompressValue(RELAY3_BYTEOFFSET,RELAY3_BITOFFSET,RELAY3_LEN,(uint8_t *)devStatusPtr,dataPoints->valueRelay3);
    if(dataPoints->valueEnumeration >= ENUMERATION_VALUE_MAX)
    {
        GIZWITS_LOG("[ERROR] valueEnumeration Error , Illegal Overstep\n");
        return -1;
    }
    else
    {
        gizCompressValue(ENUMERATION_BYTEOFFSET,ENUMERATION_BITOFFSET,ENUMERATION_LEN,(uint8_t *)devStatusPtr,dataPoints->valueEnumeration);  
    }
    gizByteOrderExchange((uint8_t *)devStatusPtr->wBitBuf,sizeof(devStatusPtr->wBitBuf));

    devStatusPtr->valueData0 = gizY2X(DATA0_RATIO,  DATA0_ADDITION, dataPoints->valueData0); 
    devStatusPtr->valueData1 = gizY2X(DATA1_RATIO,  DATA1_ADDITION, dataPoints->valueData1); 
    devStatusPtr->valueData2 = gizY2X(DATA2_RATIO,  DATA2_ADDITION, dataPoints->valueData2); 
    devStatusPtr->valueData3 = gizY2X(DATA3_RATIO,  DATA3_ADDITION, dataPoints->valueData3); 
    devStatusPtr->valueData4 = gizY2X(DATA4_RATIO,  DATA4_ADDITION, dataPoints->valueData4); 
    devStatusPtr->valueData5 = gizY2X(DATA5_RATIO,  DATA5_ADDITION, dataPoints->valueData5); 
    devStatusPtr->valueData6 = gizY2X(DATA6_RATIO,  DATA6_ADDITION, dataPoints->valueData6); 
    devStatusPtr->valueData7 = gizY2X(DATA7_RATIO,  DATA7_ADDITION, dataPoints->valueData7); 
    devStatusPtr->valueData8 = gizY2X(DATA8_RATIO,  DATA8_ADDITION, dataPoints->valueData8); 
    devStatusPtr->valueData9 = gizY2X(DATA9_RATIO,  DATA9_ADDITION, dataPoints->valueData9); 
    devStatusPtr->valueData10 = gizY2X(DATA10_RATIO,  DATA10_ADDITION, dataPoints->valueData10); 

    devStatusPtr->valueADC = gizProtocolExchangeBytes(gizY2XFloat(ADC_RATIO,  ADC_ADDITION, dataPoints->valueADC));     



    memcpy((uint8_t *)devStatusPtr->valueBig_data,(uint8_t *)&dataPoints->valueBig_data,sizeof(dataPoints->valueBig_data));
    return 0;
}
