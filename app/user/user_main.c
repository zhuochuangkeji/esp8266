...
#define KEY_1_IO_MUX                            PERIPHS_IO_MUX_GPIO5_U       ///< ESP8266 GPIO 功能
#define KEY_1_IO_NUM                            5                          ///< ESP8266 GPIO 编号
#define KEY_1_IO_FUNC                           FUNC_GPIO5                 ///< ESP8266 GPIO 名称
...
{
        /*
    currentDataPoint.valueADC = ;//Add Sensor Data Collection
